...
plugin_ohif_viewer_ver = 3.0.1-XNAT-1.8.0
...
plugin_ohif_viewer_url = https://api.bitbucket.org/2.0/repositories/icrimaginginformatics/ohif-viewer-xnat-plugin/downloads/ohif-viewer-$(plugin_ohif_viewer_ver).jar
plugin_ohif_viewer_jar = ohif-viewer-plugin-$(plugin_ohif_viewer_ver).jar
#$(info    $(plugin_ohif_viewer_url))

plugins = $(plugin_container_service_jar) $(plugin_ldap_auth_jar) $(plugin_openid_auth_jar) $(plugin_ohif_viewer_jar)
